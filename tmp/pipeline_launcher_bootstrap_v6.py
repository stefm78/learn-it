...
v6 goals:
- keep low-context discovery
- emit a single synthetic menu
- emit next best actions in a stable structure
- make the launcher usable as an entry selector before any deep AI work
