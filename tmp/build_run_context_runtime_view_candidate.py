...
def resolved_stage_inputs(
    ...
    # generic fallback when no skill binding exists yet
    base = [
...
def build_run_context(
    ...
    return {
        "run_context": {
            "schema_version": 0.2,
            "generated_by": "build_run_context_runtime_view_candidate.py",
            "note": (
...
def main() -> int:
    ...
    out_path = Path(args.output_path) if args.output_path else (inputs_dir / "run_context.yaml")
