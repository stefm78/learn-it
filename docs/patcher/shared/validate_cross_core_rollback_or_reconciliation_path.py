...
REPO = Path.cwd()
VALIDATOR_ID = 'validate_cross_core_rollback_or_reconciliation_path'
CONTRACT = 'docs/pipelines/cross_core_contract/validators/validate_cross_core_rollback_or_reconciliation_path.contract.yaml'
FUTURE_INPUTS = ['docs/pipelines/cross_core_contract/work/l4_recovery/rollback_or_reconciliation_path.yaml']
REQUIRED_MARKERS = ['rollback_or_reconciliation_path_declared', 'impacted_core_reversal_strategy_declared', 'backlog_reconciliation_strategy_declared', 'operator_recovery_steps_declared']
