...
CONTRACT = 'docs/pipelines/cross_core_contract/validators/validate_cross_core_l4_transition_review.contract.yaml'
FUTURE_INPUTS = ['docs/pipelines/cross_core_contract/reports/l4_transition_review.yaml']
REQUIRED_MARKERS = ['explicit_human_decision_recorded', 'declared_write_surface', 'rollback_or_reconciliation_path_declared']
