...
REPO = Path.cwd()
VALIDATOR_ID = 'validate_multi_core_promotion_manifest'
CONTRACT = 'docs/pipelines/cross_core_contract/validators/validate_multi_core_promotion_manifest.contract.yaml'
FUTURE_INPUTS = ['docs/cores/current/manifest.yaml', 'docs/pipelines/cross_core_contract/work/07_multi_core_release_planning/multi_core_release_plan.yaml']
REQUIRED_MARKERS = ['promotion_manifest_declares_all_impacted_cores', 'promotion_manifest_references_validated_multi_core_release', 'promotion_manifest_declares_compatibility_matrix', 'no_partial_promotion_for_cross_core_change']
