...
REPO = Path.cwd()
VALIDATOR_SPECS = {'validate_multi_core_release_plan': {'script': 'docs/patcher/shared/validate_multi_core_release_plan.py', 'contract_check_report': 'docs/registry/reports/validate_multi_core_release_plan_contract_check.yaml'}, 'validate_multi_core_promotion_manifest': {'script': 'docs/patcher/shared/validate_multi_core_promotion_manifest.py', 'contract_check_report': 'docs/registry/reports/validate_multi_core_promotion_manifest_contract_check.yaml'}, 'validate_cross_core_backlog_resolution': {'script': 'docs/patcher/shared/validate_cross_core_backlog_resolution.py', 'contract_check_report': 'docs/registry/reports/validate_cross_core_backlog_resolution_contract_check.yaml'}, 'validate_cross_core_rollback_or_reconciliation_path': {'script': 'docs/patcher/shared/validate_cross_core_rollback_or_reconciliation_path.py', 'contract_check_report': 'docs/registry/reports/validate_cross_core_rollback_or_reconciliation_path_contract_check.yaml'}}
...
def main() -> int:
    report_path = Path(sys.argv[1]) if len(sys.argv) > 1 else Path("docs/registry/reports/cross_core_l4_executable_validators_batch2_validation.yaml")
    findings = []
    checked = []
    ...
    lines = [
        'cross_core_l4_executable_validators_batch2_validation:',
        "  schema_version: '0.1'",
        ...
        '  batch2_executable_validator_count: 4',
        '  checked_files:',
    ]
    for item in checked:
