...
CONTRACT = 'docs/pipelines/cross_core_contract/validators/validate_link_binding_consistency.contract.yaml'
FUTURE_INPUTS = ['docs/pipelines/cross_core_contract/work/03_contract_synthesis/cross_core_execution_contract.yaml']
REQUIRED_MARKERS = ['every_cross_core_reference_has_link_binding', 'referentiel_parameter_ids_resolvable', 'constitution_external_reference_ids_resolvable']
