...
CONTRACT = 'docs/pipelines/cross_core_contract/validators/validate_cross_core_write_surface.contract.yaml'
FUTURE_INPUTS = ['docs/pipelines/cross_core_contract/work/03_contract_synthesis/cross_core_execution_contract.yaml', 'docs/pipelines/cross_core_contract/reports/l4_transition_review.yaml']
REQUIRED_MARKERS = ['declared_write_surface', 'every_write_target_has_owner', 'every_write_target_has_validation_gate']
