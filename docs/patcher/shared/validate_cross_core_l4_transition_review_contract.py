...
REQUIRED_MARKERS = {
    'docs/pipelines/cross_core_contract/validators/validate_cross_core_l4_transition_review.contract.yaml': [
        ...
        'explicit_human_decision_recorded',
        'declared_write_surface',
        'rollback_or_reconciliation_path_declared',
    ...
    'docs/pipelines/cross_core_contract/AI_PROTOCOL.yaml': [
        'validate_cross_core_l4_transition_review_contract:',
        'contract_defined: true',
        'executable_as_l4_gate_now: false',
    ],
    'docs/pipelines/cross_core_contract/pipeline.md': [
    ...
    'docs/pipelines/cross_core_contract/state.yaml': [
        'validate_cross_core_l4_transition_review_contract_defined: true',
        'executable_as_l4_gate_now: false',
    ],
    'docs/pipelines/cross_core_contract/requests/CCR_PATCH_LIFECYCLE_ESCALATION_THRESHOLD_N_R01.yaml': [
        'status: proposed',
...
def main() -> int:
    report_path = Path(sys.argv[1]) if len(sys.argv) > 1 else Path('docs/registry/reports/cross_core_l4_transition_review_validator_contract_validation.yaml')
    findings = []
    checked = []
    ...
    lines = [
        'cross_core_l4_transition_review_validator_contract_validation:',
        "  schema_version: '0.1'",
    ...
    lines.extend([
        ...
        '    transition_review_validator_contract_defined: true',
        '    l4_active_now: false',
        '    executable_as_l4_gate_now: false',
        '    core_mutation_authorized: false',
        '    backlog_closure_authorized: false',
