...
CONTRACT = 'docs/pipelines/cross_core_contract/validators/validate_multi_core_release_plan.contract.yaml'
FUTURE_INPUTS = ['docs/pipelines/cross_core_contract/work/07_multi_core_release_planning/multi_core_release_plan.yaml', 'docs/pipelines/cross_core_contract/work/03_contract_synthesis/cross_core_execution_contract.yaml']
REQUIRED_MARKERS = ['release_plan_declares_release_id', 'release_plan_declares_all_impacted_cores', 'release_plan_declares_artifact_manifest', 'release_plan_declares_compatibility_matrix']
