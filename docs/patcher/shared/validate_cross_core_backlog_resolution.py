...
REPO = Path.cwd()
VALIDATOR_ID = 'validate_cross_core_backlog_resolution'
CONTRACT = 'docs/pipelines/cross_core_contract/validators/validate_cross_core_backlog_resolution.contract.yaml'
FUTURE_INPUTS = ['docs/pipelines/cross_core_contract/reports/closeout_and_backlog_resolution.yaml']
REQUIRED_MARKERS = ['backlog_resolution_mapping_declared', 'each_backlog_entry_has_resolution_status', 'no_backlog_closure_without_validated_resolution', 'post_closeout_backlog_state_declared']
