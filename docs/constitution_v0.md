...
2. **Moteur générique basé sur un graphe de connaissances**  
   Le cœur du système est un moteur générique, indépendant du domaine, qui manipule des concepts, des relations de prérequis et des types de tâches. Chaque cours ou document est représenté comme un graphe orienté de connaissances, sur lequel le jeu instancie des cartes, puzzles, missions et “boss”. Le graphe sert explicitement à gérer la charge intrinsèque : tant que certains prérequis ne sont pas maîtrisés, le système évite de proposer des puzzles qui combinent trop de concepts simultanément. Les décisions adaptatives (quels contenus, dans quel ordre) doivent rester **explicables** : l’étudiant et l’enseignant doivent pouvoir comprendre, au moins qualitativement, pourquoi telle mission est proposée.
...
5. **Hyper‑personnalisation du parcours**  
   ...
   L’adaptation reste **ouverte** : le système recommande un niveau de difficulté “sûr” mais permet à l’étudiant (et à l’enseignant) de choisir des défis plus ambitieux. Aucun plafond de difficulté n’est imposé de manière définitive : les protections passent par le scaffolding (indices, décomposition) et des messages d’avertissement, pas par le blocage de contenus.
...
- Personnalisation et systèmes adaptatifs : cadres pour adaptive learning et systèmes d’apprentissage pilotés par l’IA, avec des garde‑fous en matière de biais, d’équité et de transparence.
